...
import type { FormSubmissionEvent, PaymentSubmissionEvent } from './submissionEvents';
export type FormElementTypeGroup = 'STATIC' | 'INPUT' | 'DATE' | 'OPTIONS' | 'ADVANCED';
...
export type ConditionallyShowPredicate = ConditionallyShowPredicateNumeric | ConditionallyShowPredicateOptions;
...
export type FormElementWithOptions = RadioButtonElement | CheckboxElement | SelectElement | AutoCompleteElement;
