...
export type ConditionalPredicate = ConditionalPredicateNumeric | ConditionalPredicateOptions;
...
export type PaymentSubmissionEvent = CPPaySubmissionEvent | BPOINTSubmissionEvent;
